...
public class LessThanOrEqualToPredicate<E extends ABaseEntity, T extends IGenericConditionItem<?>> implements IPredicate<E, T> {

    public LessThanOrEqualToPredicate() {
        PredicateFactoryRegistry.register(ConditionTypeEnum.LessThanOrEqualTo, this);
    }
